...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.api_account'
        db.add_column('data_account', 'api_account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['api.ApiAccount'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.api_account'
        db.delete_column('data_account', 'api_account_id')
