...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'data_event', 'watermark', 'are_photos_watermarked')

        # Adding field 'Event.photos_streamable'
        db.add_column(u'data_event', 'are_photos_streamable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Event.photos_streamable'
        db.delete_column(u'data_event', 'are_photos_streamable')

        db.rename_column(u'data_event', 'are_photos_watermarked', 'are_watermark')
