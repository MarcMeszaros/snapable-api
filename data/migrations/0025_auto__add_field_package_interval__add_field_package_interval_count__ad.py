...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Package.interval'
        db.add_column('data_package', 'interval',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=5, null=True),
                      keep_default=False)

        # Adding field 'Package.interval_count'
        db.add_column('data_package', 'interval_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Package.trial_period_days'
        db.add_column('data_package', 'trial_period_days',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Package.interval'
        db.delete_column('data_package', 'interval')

        # Deleting field 'Package.interval_count'
        db.delete_column('data_package', 'interval_count')

        # Deleting field 'Package.trial_period_days'
        db.delete_column('data_package', 'trial_period_days')
