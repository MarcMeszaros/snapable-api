...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AccountAddon.order'
        db.delete_column('data_accountaddon', 'order_id')

        # Deleting field 'EventAddon.order'
        db.delete_column('data_eventaddon', 'order_id')


    def backwards(self, orm):
        # Adding field 'AccountAddon.order'
        db.add_column('data_accountaddon', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['data.Order'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)

        # Adding field 'EventAddon.order'
        db.add_column('data_eventaddon', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['data.Order'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)
