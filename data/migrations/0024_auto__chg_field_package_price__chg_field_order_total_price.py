...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('data_package', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))
        if not db.dry_run:
        ...
        # Changing field 'Package.price'
        db.alter_column('data_package', 'price', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Order.total_price'
        db.alter_column('data_order', 'total_price', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))
        if not db.dry_run:
        ...
        # Changing field 'Order.total_price'
        db.alter_column('data_order', 'total_price', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):
        # some values might be truncated when converting from int to float
        raise RuntimeError("Cannot reverse this migration. Values might be truncated during conversion.")
