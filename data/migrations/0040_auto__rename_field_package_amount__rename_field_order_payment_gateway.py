...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename 'price' field to 'amount'
        db.rename_column('data_package', 'price', 'amount')

        # Rename 'payment_gateway_invoice_id' field to 'charge_id'
        db.rename_column('data_order', 'payment_gateway_invoice_id', 'charge_id')


    def backwards(self, orm):
        # User chose to not deal with backwards NULL issues for 'Package.price'
        raise RuntimeError("Cannot reverse this migration. 'Package.price' and its values cannot be restored.")
