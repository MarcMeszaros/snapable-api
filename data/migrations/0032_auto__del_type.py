...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Type'
        db.delete_table(u'data_type')

        # Deleting field 'Album.type'
        db.delete_column(u'data_album', 'type_id')

        # Deleting field 'Guest.type'
        db.delete_column(u'data_guest', 'type_id')

        # Deleting field 'Photo.type'
        db.delete_column(u'data_photo', 'type_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Type'
        raise RuntimeError("Cannot reverse this migration. 'Type' and its values cannot be restored.")
