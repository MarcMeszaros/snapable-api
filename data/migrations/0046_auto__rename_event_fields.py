...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'data_event', 'end', 'end_at')
        db.rename_column(u'data_event', 'start', 'start_at')
        db.rename_column(u'data_event', 'enabled', 'is_enabled')
        db.rename_column(u'data_event', 'public', 'is_public')

    def backwards(self, orm):
        db.rename_column(u'data_event', 'end_at', 'end')
        db.rename_column(u'data_event', 'start_at', 'start')
        db.rename_column(u'data_event', 'is_enabled', 'enabled')
        db.rename_column(u'data_event', 'is_public', 'public')
