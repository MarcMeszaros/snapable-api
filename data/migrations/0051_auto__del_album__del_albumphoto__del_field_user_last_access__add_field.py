...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'data_album')

        # Deleting model 'AlbumPhoto'
        db.delete_table(u'data_albumphoto')

    def backwards(self, orm):
        # User chose to not deal with backwards NULL issues for 'User.last_access'
        raise RuntimeError("Cannot reverse this migration. 'User.last_access' and its values cannot be restored.")
