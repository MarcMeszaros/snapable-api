...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename field 'Event.creation_date'
        db.rename_column('data_event', 'creation_date', 'created')


    def backwards(self, orm):
        # Revert rename field 'Event.creation_date'
        db.rename_column('data_event', 'created', 'creation_date')
