...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('data_photo', 'filename')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Photo.filename'
        raise RuntimeError("Cannot reverse this migration. 'Photo.filename' and its values cannot be restored.")
