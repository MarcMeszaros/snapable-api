...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('data', ['Addon'])

        # Adding model 'EventAddon'
        db.create_table('data_eventaddon', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Event'])),
            ('addon', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Addon'])),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['data.Order'], null=True, on_delete=models.SET_NULL)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('paid', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('data', ['EventAddon'])

        # Adding model 'Order'
        db.create_table('data_order', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Event'])),
            ('total', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('items', self.gf('jsonfield.fields.JSONField')()),
            ('payment_gateway_invoice_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('print_gateway_invoice_id', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal('data', ['Order'])

        # Adding field 'User.payment_gateway_user_id'
        db.add_column('data_user', 'payment_gateway_user_id',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('data_addon')

        # Deleting model 'EventAddon'
        db.delete_table('data_eventaddon')

        # Deleting model 'Order'
        db.delete_table('data_order')

        # Deleting field 'User.payment_gateway_user_id'
        db.delete_column('data_user', 'payment_gateway_user_id')
    ...
    models = {
        ...
        'data.order': {
            ...
            'print_gateway_invoice_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
