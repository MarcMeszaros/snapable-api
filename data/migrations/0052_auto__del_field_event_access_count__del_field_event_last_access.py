...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.access_count'
        db.delete_column(u'data_event', 'access_count')

        # Deleting field 'Event.last_access'
        db.delete_column(u'data_event', 'last_access')

        # Deleting field 'Photo.metrics'
        db.delete_column(u'data_photo', 'metrics')
