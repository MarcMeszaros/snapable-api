...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'data_order', 'amount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Order.amount_refunded'
        db.add_column(u'data_order', 'amount_refunded',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'data_order', 'amount')

        # Deleting field 'Order.amount_refunded'
        db.delete_column(u'data_order', 'amount_refunded')
