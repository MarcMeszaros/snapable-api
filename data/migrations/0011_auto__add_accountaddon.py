...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AccountAddon'
        db.create_table('data_accountaddon', (
        ...
        db.send_create_signal('data', ['AccountAddon'])        

    def backwards(self, orm):
        # Deleting model 'AccountAddon'
        db.delete_table('data_accountaddon')
