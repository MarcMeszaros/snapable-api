...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('data_event', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        if not db.dry_run:
            # Convert all the data fields
            for event in orm.Event.objects.all():
                if event.type == orm.Type.objects.get(pk=6):
                    event.public = True
                else:
                    event.public = False
        ...
        db.delete_column('data_event', 'type_id')
    ...
    def backwards(self, orm):
        ...
        db.delete_column('data_event', 'public')
