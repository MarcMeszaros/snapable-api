...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('data_user', 'created', 'created_at')
        db.rename_column('data_photo', 'timestamp', 'created_at')
        db.rename_column('data_passwordnonce', 'timestamp', 'created_at')
        db.rename_column('data_order', 'timestamp', 'created_at')
        db.rename_column('data_event', 'created', 'created_at')


    def backwards(self, orm):
        db.rename_column('data_user', 'created_at', 'created')
        db.rename_column('data_photo', 'created_at', 'timestamp')
        db.rename_column('data_passwordnonce', 'created_at', 'timestamp')
        db.rename_column('data_order', 'created_at', 'timestamp')
        db.rename_column('data_event', 'created_at', 'created')
