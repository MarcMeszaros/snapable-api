...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'data_passwordnonce', 'valid', 'is_valid')
        db.rename_column(u'data_package', 'enabled', 'is_enabled')
        db.rename_column(u'data_photo', 'streamable', 'is_streamable')

    def backwards(self, orm):
        db.rename_column(u'data_passwordnonce', 'is_valid', 'valid')
        db.rename_column(u'data_package', 'is_enabled', 'enabled')
        db.rename_column(u'data_photo', 'is_streamable', 'streamable')
    ...
    models = {
        ...
        'data.photo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_streamable': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        'data.user': {
