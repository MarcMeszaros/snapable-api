...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PasswordNonce'
        db.create_table('data_passwordnonce', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.User'])),
            ('nonce', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('valid', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('data', ['PasswordNonce'])


    def backwards(self, orm):
        # Deleting model 'PasswordNonce'
        db.delete_table('data_passwordnonce')
