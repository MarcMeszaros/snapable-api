...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename the last_access field
        db.rename_column(u'data_user', 'last_access', 'last_login')

        # Changing field 'User.password'
        db.alter_column(u'data_user', 'password', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Undo the last_access rename
        db.rename_column(u'data_user', 'last_login', 'last_access')

        # Changing field 'User.password'
        db.alter_column(u'data_user', 'password', self.gf('django.db.models.fields.CharField')(max_length=255))
