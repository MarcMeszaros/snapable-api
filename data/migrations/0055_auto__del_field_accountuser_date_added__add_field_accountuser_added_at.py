...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'data_accountuser', 'date_added', 'added_at')
        db.rename_column(u'data_guest', 'invited', 'is_invited')


    def backwards(self, orm):
        db.rename_column(u'data_accountuser', 'added_at', 'date_added')
        db.rename_column(u'data_guest', 'is_invited', 'invited')
