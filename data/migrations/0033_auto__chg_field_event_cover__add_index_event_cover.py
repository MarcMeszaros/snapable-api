...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Event.cover' to match new field type.
        db.rename_column(u'data_event', 'cover', 'cover_id')
        # Changing field 'Event.cover'
        db.alter_column(u'data_event', 'cover_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['data.Photo']))
        # Adding index on 'Event', fields ['cover']
        db.create_index(u'data_event', ['cover_id'])
    ...
    def backwards(self, orm):
        # Removing index on 'Event', fields ['cover']
        db.delete_index(u'data_event', ['cover_id'])

        # Renaming column for 'Event.cover' to match new field type.
        db.rename_column(u'data_event', 'cover_id', 'cover')
        # Changing field 'Event.cover'
        db.alter_column(u'data_event', 'cover', self.gf('django.db.models.fields.IntegerField')())
